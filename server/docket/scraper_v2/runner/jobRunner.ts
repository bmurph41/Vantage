...
export function startDocketV2Runner(): void {
  if (!isV2Enabled()) {
    logger.info({
      module: 'docket_v2',
      event: 'runner_disabled',
      message: 'Docket V2 runner is disabled. Set DOCKET_SCRAPER_V2=true to enable.',
    });
    return;
  }
...
export function stopDocketV2Runner(): void {
  if (runnerInterval) {
