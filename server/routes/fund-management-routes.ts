...
// ============================================================================
// B.1 — Fund-Level Model — see /api/funds/* (V1 FundService, modeling-routes.ts)
// Removed V2 fund CRUD here (funds_v2 table) — it duplicated V1 and broke when
// UI hit /api/funds/* (V1) while this path read V2, producing 404s on seeded data.
// ============================================================================
...
// Side letters live at /api/lp-portal/side-letters/* — see lp-portal-routes.ts.
// V2 routes that read fundsV2 were removed: client never called them and they
// 404'd on V1-seeded funds.
