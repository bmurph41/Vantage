...
const STATE_TO_REGION: Record<string, string> = {
  'FL': 'Southeast', 'GA': 'Southeast', 'SC': 'Southeast', 'NC': 'Southeast', 'AL': 'Southeast', 'MS': 'Southeast', 'LA': 'Southeast',
  'TX': 'Southwest', 'AZ': 'Southwest', 'NM': 'Southwest', 'OK': 'Southwest',
  'CA': 'West', 'WA': 'West', 'OR': 'West', 'NV': 'West', 'HI': 'West', 'AK': 'West',
  'NY': 'Northeast', 'NJ': 'Northeast', 'CT': 'Northeast', 'MA': 'Northeast', 'RI': 'Northeast', 'NH': 'Northeast', 'VT': 'Northeast', 'ME': 'Northeast', 'PA': 'Northeast',
  'MD': 'Mid-Atlantic', 'VA': 'Mid-Atlantic', 'DE': 'Mid-Atlantic', 'DC': 'Mid-Atlantic',
  'MI': 'Great Lakes', 'OH': 'Great Lakes', 'IL': 'Great Lakes', 'WI': 'Great Lakes', 'MN': 'Great Lakes', 'IN': 'Great Lakes',
};
