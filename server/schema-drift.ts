...
const EXTRA_TABLE_ALLOWLIST = new Set<string>([
  ...
  "settings_audit_log",
  "report_schedules",
  // — Dockit marina management sub-system (module-owned schema, not Drizzle-managed)
  "dockit_api_keys",
  "dockit_analytics_snapshots",
  "dockit_audit_logs",
  "dockit_billing_schedules",
  "dockit_boats",
  "dockit_communications",
  "dockit_contract_templates",
  "dockit_contracts",
  "dockit_customers",
  "dockit_import_errors",
  "dockit_import_jobs",
  "dockit_integrations",
  "dockit_launches",
  "dockit_leases",
  "dockit_marina_layouts",
  "dockit_marinas",
  "dockit_message_threads",
  "dockit_messages",
  "dockit_notification_preferences",
  "dockit_notifications",
  "dockit_organizations",
  "dockit_payments",
  "dockit_pricing_rules",
  "dockit_reservations",
  "dockit_sessions",
  "dockit_slips",
  "dockit_slip_pricing",
  "dockit_user_marina_roles",
  "dockit_users",
  "dockit_waitlist",
  "dockit_webhook_deliveries",
  "dockit_webhooks",
]);
