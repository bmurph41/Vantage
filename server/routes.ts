...
import { publicAssetClassRouter, adminAssetClassRouter } from "./routes/admin/asset-classes-routes";
...
// ─── PNL Pipeline Import (DocIntel upload → PNL pipeline → modelingActuals) ──
  ...
  app.use("/api/asset-classes", publicAssetClassRouter);
  app.use("/api/asset-classes", authenticateUser, assetClassContextRouter);
  app.use("/api/admin/asset-classes", authenticateUser, adminAssetClassRouter);
