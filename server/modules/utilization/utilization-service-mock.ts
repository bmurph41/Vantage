...
import { startOfMonth, endOfMonth, daysBetween } from './overlap';
    ...
    byUnitType: [
      {
        ...
        bands: [
          ...
          },
          {
            bandKey: '61_plus',
            bandLabel: "61'+",
            unitUtil: { totalUnits: 12, occupiedUnits: 10, vacantUnits: 2, offlineUnits: 0, availableUnits: 12, utilizationPct: 83.3 },
            weightedUtil: { denomType: 'lf', totalCapacity: 950, occupiedCapacity: 860, offlineCapacity: 0, availableCapacity: 950, weightedUtilPct: 90.5, label: 'Linear Feet' },
            economicUtil: { revenuePerAvailableCapacityTime: 2.8, effectiveRate: 2700, rackRate: null, rateRealizationPct: null, label: 'Rev/Available LF-Day' },
          },
        ],
      },
      {
