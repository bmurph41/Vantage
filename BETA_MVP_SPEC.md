...
6. **Don't ship architectural changes mid-investigation.** When a Phase 0 audit surfaces unexpected scope, surface the finding and re-plan before code. The Day 12 pivot (engine unification → MVP) is the model.
