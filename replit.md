...
- **CRM & Pipeline (Split Navigation)**: The sidebar has separate "CRM" and "Pipeline" sections. CRM contains Contacts, Companies, Properties. Pipeline contains Prospecting, Pipeline (Deal Board, Activity Log, Follow-Ups, Forecast), Marketing, Analytics, and Tools & Settings.
