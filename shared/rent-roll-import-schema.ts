...
export const LEASE_FIELDS: ImportFieldDefinition[] = [
  ...
  { id: "storageType", label: "Storage Type", type: "text", required: false, recommended: true, aliases: ["type", "storage", "category", "class", "storage type", "slip type"], validValues: ["Wet Slip", "Wet Slips", "Lift Slip", "Lift Slips", "Mooring", "Moorings", "Jet Ski", "Jet Skis", "Dry Rack - Indoor", "Dry Racks - Indoor", "Dry Rack - Outdoor", "Dry Racks - Outdoor", "Houseboat", "Houseboats", "Liveaboard", "Liveaboards", "Land Storage", "Boat on Trailer", "Trailered Boats", "Trailer Only", "Trailers", "Dinghies/Small Boats", "Carports", "RV Sites", "Cabins", "Sales", "Service", "Commercial", "Rental Boats", "Boat Club", "Mixed"] },
