...
import { BarChart3, Fuel, ShoppingCart, Wrench, Ship, TrendingUp, Building2 } from "lucide-react";
        ...
        <CardContent className="pt-0">
          <Tabs value={activeSubTab} onValueChange={setActiveSubTab}>
            ...
            <TabsContent value="tenants" className="mt-0">
              <ValuatorCommercialTenantsTab projectId={projectId} projectName={projectName} />
            </TabsContent>
