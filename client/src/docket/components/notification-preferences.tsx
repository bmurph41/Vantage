...
export default function NotificationPreferences({
  ...
  const { data: notifications, isLoading: notificationsLoading } = useQuery<any[]>({
    queryKey: ["/api/docket/notifications"],
  ...
  const createSearchMutation = useMutation({
    mutationFn: async (data: SavedSearchForm) => {
      return await apiRequest("/api/docket/saved-searches", {
        method: "POST",
  ...
  const deleteSearchMutation = useMutation({
    ...
    onSuccess: async () => {
      await queryClient.invalidateQueries({ queryKey: ["/api/docket/saved-searches"] });
      await queryClient.refetchQueries({ queryKey: ["/api/docket/saved-searches"] });
