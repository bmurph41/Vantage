...
export const SUBSCRIPTION_PACKAGES: SubscriptionPackage[] = [
  ...
  },
  {
    ...
    slug: 'investor',
    name: 'Analyst',
    description: 'Underwrite deals with institutional-grade modeling, comps, and market data',
    priceMonthly: 89,
    priceYearly: 890,
    ...
    features: [
      ...
      'Pro Forma, DCF & Monte Carlo modeling',
      'Exit Strategy Suite',
  ...
  },
  {
    ...
    slug: 'broker',
    name: 'Broker',
    description: 'Win more listings and close faster with CRM, pipeline, and marketing tools',
    priceMonthly: 179,
    priceYearly: 1790,
    popular: true,
  ...
  },
  {
    ...
    slug: 'owner-operator',
    name: 'Owner',
    description: 'Run your assets end-to-end — deals, tenants, operations, and financials in one place',
    priceMonthly: 269,
    priceYearly: 2690,
...
export const PERSONA_OPTIONS: PersonaOption[] = [
  {
    id: 'investor',
    name: 'Analyst / Investor',
    description: 'I underwrite and evaluate acquisitions',
    icon: 'TrendingUp',
  ...
  },
  {
    id: 'broker',
    name: 'Broker / Advisor',
    description: 'I source, market, and close deals for clients',
    icon: 'Handshake',
  ...
  },
  {
    id: 'owner',
    name: 'Owner / Operator',
    description: 'I own or manage commercial real estate',
    icon: 'Anchor',
  ...
  },
  {
    id: 'lender',
    name: 'Lender',
    description: 'I provide financing for CRE acquisitions',
    icon: 'Landmark',
    recommendedPackage: 'investor',
  },
  {
    id: 'consultant',
    name: 'Fund Manager',
    description: 'I manage funds, LPs, and institutional capital',
    icon: 'Briefcase',
