    ...
    subcategories: [
      ...
      // ── Asset-class-specific subcategories ──
      {
        ...
        items: [
          ...
          { id: 'service-dept', label: 'Service & Parts', href: '/operations/service', icon: WrenchIcon, matchRoutes: ['/operations/service', '/service-dept', '/operations/service-dept'], opsModuleKey: 'service', requiredModules: [FEATURE_MODULES.OPS_SERVICE] },
