...
import type { Project, SalesComp } from "@shared/schema";
        ...
        <DialogHeader>
          <div className="flex items-center justify-between">
            <DialogTitle className="flex items-center gap-2">
              ...
              Recommended Sales Comps for {project.name}
            </DialogTitle>
            <Button
              variant="ghost"
              size="sm"
          ...
          {!isLoading && !error && filteredRecommendations.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground">
                Try updating your project profile or add more sales comps to improve recommendations.
              </p>
            </div>
          )}
