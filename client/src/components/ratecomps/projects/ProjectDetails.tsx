...
import { useProject, useProjectComps, useUpdateProject, useDeleteProject } from '@/hooks/ratecomps/useProjects';
...
import type { RcProject, UpdateRcProject, RateComp, User } from "@shared/schema";
import type { ProjectCompsResponse } from '@/lib/ratecomps/api';

interface ProjectDetailsProps {
  projectId: string;
  onClose: () => void;
  onEdit?: (project: RcProject) => void;
}
...
export default function ProjectDetails({ projectId, onClose, onEdit }: ProjectDetailsProps) {
  ...
  const sortedComps = [...filteredComps].sort((a, b) => {
    const aValue = a.salesComp[sortBy as keyof RateComp] || '';
    const bValue = b.salesComp[sortBy as keyof RateComp] || '';
