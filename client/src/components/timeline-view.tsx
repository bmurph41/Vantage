                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        ...
                        >
                          <div className={`w-3 h-12 rounded-full shadow-xl border-2 ring-2 hover:scale-110 transition-all duration-300 hover:shadow-2xl ${
                            isCompleted 
                          ...
                          <div className={`absolute top-14 left-1/2 transform -translate-x-1/2 backdrop-blur-sm border-2 rounded-xl px-3 py-2 shadow-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap z-50 ring-1 ${
                            isCompleted 
                        ...
                        {project.psaSignedDate && (
                          ...
                          >
                            ...
                            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gradient-to-br from-white to-blue-50/95 backdrop-blur-sm border-2 border-blue-200/80 rounded-xl px-3 py-2 shadow-2xl z-[100] pointer-events-none whitespace-nowrap ring-1 ring-blue-100/60">
                        ...
                        {project.ddExpirationDate && (
                          ...
                          >
                            ...
                            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gradient-to-br from-white to-amber-50/95 backdrop-blur-sm border-2 border-amber-200/80 rounded-xl px-3 py-2 shadow-2xl z-[100] pointer-events-none whitespace-nowrap ring-1 ring-amber-100/60">
                        ...
                        {project.closingDate && (
                          ...
                          >
                            ...
                            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gradient-to-br from-white to-green-50/95 backdrop-blur-sm border-2 border-green-200/80 rounded-xl px-3 py-2 shadow-2xl z-[100] pointer-events-none whitespace-nowrap ring-1 ring-green-100/60">
                        ...
                        {/* Custom Deadline Markers */}
                        {project.customDeadlines && (Array.isArray(project.customDeadlines) ? project.customDeadlines : [])
                          .filter((deadline: any) => deadline.showOnTimeline && deadline.date && deadline.label)
                          .map((deadline: any, index: number) => (
                          <div 
                            key={`custom-deadline-${index}`}
                            className="absolute top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 group cursor-pointer"
                            style={{ left: `${getMilestonePosition(deadline.date)}%` }}
                            data-testid={`milestone-custom-deadline-${index}`}
                          >
                            <div className="w-4 h-4 bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 rounded-full border-3 border-white shadow-xl hover:scale-150 transition-all duration-300 hover:shadow-2xl ring-2 ring-purple-200/60 hover:ring-purple-300/80" />
                            <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300 bg-gradient-to-br from-white to-purple-50/95 backdrop-blur-sm border-2 border-purple-200/80 rounded-xl px-3 py-2 shadow-2xl z-[100] pointer-events-none whitespace-nowrap ring-1 ring-purple-100/60">
                              <div className="text-sm font-bold text-purple-700 mb-1 flex items-center">
