...
const styles = StyleSheet.create({
  ...
  coverTitle: {
    fontSize: 36,
    fontWeight: 'bold',
    color: '#1e3a8a', // Professional navy blue
    marginBottom: 25,
    letterSpacing: -1,
  },
  coverSubtitle: {
  ...
  sectionTitle: {
    ...
    color: '#ffffff',
    marginBottom: 20,
    backgroundColor: '#1e3a8a', // Professional navy background
    padding: 16,
    paddingLeft: 20,
    borderRadius: 8,
    textTransform: 'uppercase',
  ...
  // Enhanced KPI Dashboard styles - Professional CBRE/Marcus & Millichap inspired
  kpiGrid: {
    display: 'flex',
    flexDirection: 'row',
    flexWrap: 'wrap',
  ...
  kpiCard: {
    ...
    backgroundColor: '#f8fafc',
    borderRadius: 8,
    border: '2 solid #e1e5e9',
    boxShadow: '0 2 8 rgba(30,58,138,0.12)',
    minHeight: 150,
    position: 'relative',
  ...
  // Progress visualization - Professional styling
  progressContainer: {
    marginTop: 15,
    height: 10,
  ...
  // Risk indicator styles - Professional commercial real estate styling
  riskIndicator: {
    fontSize: 11,
    fontWeight: 'bold',
    padding: '8 16',
  ...
  // Status card styles - Clean professional design
  statusCard: {
    width: '47%',
    padding: 20,
    marginBottom: 18,
    ...
    borderRadius: 8,
    border: '2 solid #e1e5e9',
    boxShadow: '0 1 6 rgba(30,58,138,0.08)',
    minHeight: 100,
    textAlign: 'center',
    borderTop: '4 solid #1e3a8a',
  },
  statusNumber: {
    fontSize: 38,
    fontWeight: 'bold',
  ...
  taskRow: {
    ...
    borderRadius: 6,
    border: '1 solid #e5e7eb',
    boxShadow: '0 1 3 rgba(0,0,0,0.05)',
  },
  taskTitle: {
    flex: 2,
    fontSize: 10,
  ...
  // Timeline styles - Professional commercial real estate design
  timelineContainer: {
    marginTop: 25,
    marginBottom: 25,
    backgroundColor: '#ffffff',
  ...
  // Executive Summary Styles - Professional CBRE/Marcus & Millichap design
  executivePage: {
    backgroundColor: '#FFFFFF',
    padding: 50,
    fontFamily: 'Helvetica',
  ...
  keyInsight: {
    ...
    border: '2 solid #7dd3fc',
    borderRadius: 8,
    padding: 25,
    marginBottom: 25,
    borderLeft: '6 solid #1e3a8a',
  },
  keyInsightTitle: {
    fontSize: 18,
    fontWeight: 'bold',
