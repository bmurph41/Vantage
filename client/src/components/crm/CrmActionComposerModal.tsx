...
import { FileText, Calendar as CalendarIcon, Phone, Mail, Upload, CheckSquare } from 'lucide-react';
...
interface CrmActionComposerModalProps {
  ...
  defaultTab?: 'note' | 'activity' | 'call' | 'email' | 'files';
}
...
export function CrmActionComposerModal({
  ...
  const handleSubmitActivity = (type?: string) => {
  ...
  const isPending = createNoteMutation.isPending || createActivityMutation.isPending;
