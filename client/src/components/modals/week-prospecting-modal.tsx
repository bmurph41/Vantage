    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-7xl h-[90vh] overflow-hidden bg-white dark:bg-gray-900 border-0 shadow-2xl rounded-2xl flex flex-col p-0">
          ...
          <div className="flex-shrink-0 px-6 pt-6 pb-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                {saveStatus === 'saving' && (
                  <span className="text-xs text-gray-500 flex items-center gap-1.5 bg-gray-100 dark:bg-gray-800 px-3 py-1.5 rounded-full" data-testid="text-saving-indicator">
                    <Clock className="w-3 h-3 animate-spin" />
                    Saving...
                  </span>
                )}
                {saveStatus === 'saved' && (
                  <span className="text-xs text-green-600 flex items-center gap-1.5 bg-green-50 dark:bg-green-900/30 px-3 py-1.5 rounded-full" data-testid="text-saved-indicator">
                    <Check className="w-3 h-3" />
                    Saved
                  </span>
                )}
                <Badge variant="outline" className="border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 px-3 py-1.5 rounded-full text-xs font-medium">
          ...
          {/* MM-UI Blue Brand Divider */}
          <div className="h-1 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-500 flex-shrink-0" />
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white">Weekly Goals</h3>
                </div>
                <div className="flex items-center gap-3">
                  <Badge variant="outline" className="bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 px-3 py-1 rounded-full text-xs">
                  ...
                  <Button
                    ...
                    className="h-8 px-3 text-xs border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                ...
                <h3 className="text-base font-semibold text-gray-900 dark:text-white">Select Days of Week</h3>
              </div>
              <div className="p-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-base font-semibold text-gray-900 dark:text-white">Daily Activity Tracking</h3>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Progress:</span>
                  <Badge variant="outline" className="bg-blue-50 dark:bg-blue-900/30 border-blue-200 dark:border-blue-700 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full text-xs font-medium">
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                <span className="inline-flex items-center gap-1.5">
                  {weeklyStats.completedWeeklyGoals}/{weeklyGoals.length} goals
                </span>
              ...
              <div className="flex gap-3">
                <Button 
                  ...
                  className="px-5 h-10 border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg font-medium"
                >
                  Cancel
                </Button>
                <Button 
                  onClick={handleSave} 
                  className="px-5 h-10 bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-sm rounded-lg"
          ...
          <div className="px-6 pt-6 pb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <DialogDescription className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                  Capture details for {ALL_DAYS_OF_WEEK.find(d => d.id === activityBoxModal.day)?.name}
                </DialogDescription>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-6 py-4">
            <div className="flex justify-end gap-3">
              <Button 
                ...
                className="px-5 h-10 border-gray-200 dark:border-gray-600 rounded-lg font-medium"
              >
                Cancel
              </Button>
              <Button 
                onClick={saveActivityBoxDetails}
                className="px-5 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium"
