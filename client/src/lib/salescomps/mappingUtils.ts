...
export const STANDARD_FIELDS: FieldConfig[] = [
  ...
  { key: 'state', label: 'State', type: FIELD_TYPES.STATE, description: 'State or province' },
  { key: 'market', label: 'Market', type: FIELD_TYPES.TEXT, description: 'Market or city location' },
  ...
  { key: 'broker', label: 'Broker', type: FIELD_TYPES.TEXT, description: 'Listing broker or agent' },
