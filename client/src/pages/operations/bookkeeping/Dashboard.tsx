    ...
    <div className="p-6 space-y-6">
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Data Flow to Valuator</CardTitle>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground pt-2 border-t">
                Connected data automatically syncs to Modeling/Valuator for owned marina valuation models.
              </p>
            </CardContent>
          </Card>
        </div>
